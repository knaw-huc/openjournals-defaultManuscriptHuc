...
<div class="obj_article_summary">
	...
	{* Ronald Leenes, 27 sept 2021
		toevoeging vanuit article_details.tpl om abstarct toe te voegen. 
		In article sdetails staat er groot abstract boven
		<h2 class="label">{translate key="article.abstract"}</h2>		
		dat is hier niet nodig. wel moet worden ekeken welke style moet worden gebruikt voor het abstract
	*}
				{* Abstract *}
